...
<div id="tooplate_wrapper">
	...
	<div id="tooplate_header">
        ...
        <div id="tooplate_menu">
        	<ul>
                ...
                <li><a href="simulator.php" class="current">Simulation</a></li>
	...
	<div id="tooplate_main">
		...
		<img style="border:4px solid black" src="images/gallery/microbe.jpg" width="870px" border: "#000000 6px outset"/>
		<br></br>
		...
		<?php
			...
			if(isset($_POST['hit'])){
				...
				if ($disease == 1 && $infectNum == 1 && $kNodes == 0.1){
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case1.gif"/>'; // Displays gif of disease spread for given parameters
					echo'<img src="images/decisionTrees/Case1.png"/>'; // Displays image of pruned decision tree for disease spread
				...
				// Case 2
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case2.gif"/>';
					echo'<img src="images/decisionTrees/Case2.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 3
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case3.gif"/>';
					echo'<img src="images/decisionTrees/Case3.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 4
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case4.gif"/>';
					echo'<img src="images/decisionTrees/Case4.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 5
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case5.gif"/>';
					echo'<img src="images/decisionTrees/Case5.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 6
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case6.gif"/>';
					echo'<img src="images/decisionTrees/Case6.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 7
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case7.gif"/>';
					echo'<img src="images/decisionTrees/Case7.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 8
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case8.gif"/>';
					echo'<img src="images/decisionTrees/Case8.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 9
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case9.gif"/>';
					echo'<img src="images/decisionTrees/Case9.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 11
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case11.gif"/>';
					echo'<img src="images/decisionTrees/Case11.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 12
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case12.gif"/>';
					echo'<img src="images/decisionTrees/Case12.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 13
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case13.gif"/>';
					echo'<img src="images/decisionTrees/Case13.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 14
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case14.gif"/>';
					echo'<img src="images/decisionTrees/Case14.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 15
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case15.gif"/>';
					echo'<img src="images/decisionTrees/Case15.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 16
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case16.gif"/>';
					echo'<img src="images/decisionTrees/Case16.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 17
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case17.gif"/>';
					echo'<img src="images/decisionTrees/Case17.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 18
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case18.gif"/>';
					echo'<img src="images/decisionTrees/Case18.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 19
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case19.gif"/>';
					echo'<img src="images/decisionTrees/Case19.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 20
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case20.gif"/>';
					echo'<img src="images/decisionTrees/Case20.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// case 21
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case21.gif"/>';
					echo'<img src="images/decisionTrees/Case21.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 22
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case22.gif"/>';
					echo'<img src="images/decisionTrees/Case22.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 23
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case23.gif"/>';
					echo'<img src="images/decisionTrees/Case23.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 24
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case24.gif"/>';
					echo'<img src="images/decisionTrees/Case24.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 25
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case25.gif"/>';
					echo'<img src="images/decisionTrees/Case25.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 26
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case26.gif"/>';
					echo'<img src="images/decisionTrees/Case26.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 27
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case27.gif"/>';
					echo'<img src="images/decisionTrees/Case27.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 28
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case28.gif"/>';
					echo'<img src="images/decisionTrees/Case28.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 29
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case29.gif"/>';
					echo'<img src="images/decisionTrees/Case29.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 30
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case30.gif"/>';
					echo'<img src="images/decisionTrees/Case30.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
					<em>Total Number Infected: 1<br>
					Max Infected at a Time: 1<br>
					Total Recovered: 0<br>
				...
				// Case 31
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case31.gif"/>';
					echo'<img src="images/decisionTrees/Case31.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 32
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case32.gif"/>';
					echo'<img src="images/decisionTrees/Case32.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 33
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case33.gif"/>';
					echo'<img src="images/decisionTrees/Case33.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 34
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case34.gif"/>';
					echo'<img src="images/decisionTrees/Case34.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 35
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case35.gif"/>';
					echo'<img src="images/decisionTrees/Case35.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
				...
				// Case 36
					...
					echo'<h5>Results:</h5>';
					echo"<br>";
					echo'<img src="images/cases/Case36.gif"/>';
					echo'<img src="images/decisionTrees/Case36.png"/>';
					echo"<br><br><h5>Final Statistics:</h5>
		...
		<p><i>For information about what policies to consider, please <a href="policies.php">click here.</a><br></br>
