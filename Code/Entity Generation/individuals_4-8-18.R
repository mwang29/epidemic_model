...
for (x in c(1:nrow(individualPop))){  
  if ((individualPop$Age[x] < 18)){  
    ...
    individualPop$Workplace[x] <- sample(c("MGMT", "BFO", "CSMA", "ENGR", "LPSS", "COMSS", "LGL", "ED", "ART", "HEALTH",
                                                       "LAWENF", "FFGHT", "FOOD", "CLEAN", "PERSCARE", "SALES",
                                                       "ADMIN", "FARM", "CONSTR", "MAINT", "PROD", "TRANS", "MATMOV"), 
                                                     prob=c(0.073, 0.027, 0.030, 0.028, 0.043, 0.013, 0.007, 0.257, 0.022, 0.041, 0.008, 
                                                            0.003, 0.100, 0.021, 0.066, 0.084, 0.011, 0.004, 0.011, 0.009,
                                                            0.024, 0.010, 0.011), replace=TRUE)
